...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model_path = r'/data1/flg/torch/my_unet/DDFseg/pretrained_model/resnet/resnet50_v2.pth'
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model_path = r'/data1/flg/torch/my_unet/DDFseg/pretrained_model/resnet/resnet101_v2.pth'
        model.load_state_dict(torch.load(model_path), strict=False)
    return model


if __name__ == '__main__':
    net1 = resnet50(pretrained=True).cuda()
