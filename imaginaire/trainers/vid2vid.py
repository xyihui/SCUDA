...
class Trainer(BaseTrainer):
    ...
    def _start_of_epoch(self, current_epoch):
        ...
        # Then add the temporal networkss to generator, and train multiple frames.
    ...
    def gen_update(self, data):
        ...
        for t in range(self.sequence_length):
            ...
            # Get losses and update D if image generated by networkss in training.
            ...
            # Get losses and update G if image generated by networkss in training.
            if 'fake_images_source' not in net_G_output:
                net_G_output['fake_images_source'] = 'in_training'
            if net_G_output['fake_images_source'] != 'pretrained':
