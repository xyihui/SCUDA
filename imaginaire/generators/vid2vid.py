...
class Generator(BaseNetwork):
    ...
    def __init__(self, gen_cfg, data_cfg):
        ...
        # Label / image embedding networkss.
        ...
        # Whether to output hallucinated frame (when training temporal networkss)
        # for additional loss.
        self.generate_raw_output = False

        # Image generation networkss.
    ...
    def init_temporal_network(self, cfg_init=None):
        ...
        downsampling networkss and flow networkss.
    ...
    def get_cond_maps(self, label, embedder):
        ...
        Args:
           ...
           embedder (obj) : Embedding networkss.
        Returns:
