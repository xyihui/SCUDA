...
class Generator(nn.Module):
    ...
    def forward(self, content, style):
        ...
        """
        content_a = self.generator.content_encoder(content)  # 只提取content的内容，不提取style的内容
        content_b_zero = self.generator.content_encoder(style)
        ...
        return images_trans, images_recon, content_a, content_b_zero
