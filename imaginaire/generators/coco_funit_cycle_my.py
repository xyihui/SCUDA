...
#                                          StyleEncoder)
from models.imaginaire.generators.funit_my import StyleEncoder, ContentEncoder, MLP, Decoder
...
if __name__ == '__main__':
    model = Generator()
    data = {}
    data['images_content'] = torch.randn(2, 3, 256, 256)
    data['images_style'] = torch.randn(2, 3, 256, 256)
    out = model(data['images_content'], data['images_style'])
    print(out.shape)
