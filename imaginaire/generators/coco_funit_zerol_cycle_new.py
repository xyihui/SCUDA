...
#                                          StyleEncoder)
from imaginaire.generators.funit import StyleEncoder, ContentEncoder, MLP, Decoder
from torch.nn import functional as F

from utils.utils import bem, sam
...
class COCOFUNITTranslator(nn.Module):
    ...
    def decode(self, content, style, real_kv=None, real_kh=None, real_ks=None, real_B_kv=None, real_B_kh=None, real_B_ks=None):
        ...
        styles = style.view(batch_size, -1)
        style_in = self.mlp_style(torch.cat([styles, usb], 1))  # 风格向量
